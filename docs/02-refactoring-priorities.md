...
| Задача                                                    | Документ                                               | Сложность | Статус |
| --------------------------------------------------------- | ------------------------------------------------------ | --------- | ------ |
...
| Удалить неиспользуемые firebase-артефакты                 | [12-deployment.md](12-deployment.md)                   | S         | ✅     |

**Зависимости:** нет
**Результат:** проект линтится, `npm run lint` и `npm run format` работают. **Завершено 2026-03-12.**
...
| --------------------------- | ---------------------------------------- | ---- | --------- | ---------------------- |
| ~~ESLint + Prettier~~       | [03](03-tooling-and-linting.md)          | P0   | S         | ✅                     |
...
5. **Регрессионная проверка**: после каждого PR убедиться, что приложение работает (`npm run lint`, `npm run build`, unit/e2e-тесты, ручное тестирование). Использовать чеклист ниже
