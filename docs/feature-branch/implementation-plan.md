...
- [x] В `ResourcePlan.vue` — расширить функцию `columnHeaderTitle()` (строка 84): добавить description из групп в текст native `title` атрибута
- [x] Ручная проверка: при наведении на заголовок группы видно описание
